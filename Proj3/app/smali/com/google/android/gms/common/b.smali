...
.method static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/av;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/o;)Lcom/google/android/gms/common/api/internal/n;
    .locals 2
    ...
    invoke-direct {v0, p1}, Lcom/google/android/gms/common/api/internal/n;-><init>(Lcom/google/android/gms/common/api/internal/o;)V

    invoke-virtual {p0, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p0}, Lcom/google/android/gms/common/api/internal/n;->a(Landroid/content/Context;)V

    const-string v1, "com.google.android.gms"

    invoke-static {p0, v1}, Lcom/google/android/gms/common/r;->zzv(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private final a(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/b;->c()Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/u;->getSupportFragmentManager()Landroid/support/v4/app/y;
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/e;->show(Landroid/support/v4/app/y;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    :cond_4
    new-instance v4, Landroid/support/v4/app/al$d;

    invoke-direct {v4, p1}, Landroid/support/v4/app/al$d;-><init>(Landroid/content/Context;)V

    const v5, 0x108008a

    invoke-virtual {v4, v5}, Landroid/support/v4/app/al$d;->a(I)Landroid/support/v4/app/al$d;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/al$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/al$d;
    ...
    invoke-virtual {v3, v4, v5}, Landroid/support/v4/app/al$d;->a(J)Landroid/support/v4/app/al$d;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/al$d;->b(Z)Landroid/support/v4/app/al$d;

    move-result-object v3

    invoke-virtual {v3, p4}, Landroid/support/v4/app/al$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/al$d;

    move-result-object v3

    invoke-virtual {v3, v1}, Landroid/support/v4/app/al$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/al$d;

    move-result-object v1

    invoke-virtual {v1, v2}, Landroid/support/v4/app/al$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/al$d;

    move-result-object v1

    invoke-virtual {v1, v6}, Landroid/support/v4/app/al$d;->c(Z)Landroid/support/v4/app/al$d;

    move-result-object v1

    new-instance v3, Landroid/support/v4/app/al$c;

    invoke-direct {v3}, Landroid/support/v4/app/al$c;-><init>()V

    invoke-virtual {v3, v2}, Landroid/support/v4/app/al$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/al$c;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/app/al$d;->a(Landroid/support/v4/app/al$q;)Landroid/support/v4/app/al$d;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/al$d;->setChannelId(Ljava/lang/String;)Landroid/support/v4/app/NotificationCompat$Builder;

    :cond_5
    invoke-virtual {v1}, Landroid/support/v4/app/al$d;->b()Landroid/app/Notification;
    ...
    sget-object v3, Lcom/google/android/gms/common/r;->zzfln:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private final c()Ljava/lang/String;
    ...
    sget-object v1, Lcom/google/android/gms/common/b;->c:Ljava/lang/Object;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, v0}, Lcom/google/android/gms/common/j;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/av;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/av;

    move-result-object v0

    invoke-static {p1, p2, v0, p4}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/av;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/google/android/gms/common/j;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Lcom/google/android/gms/common/j;->a(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
...
.method public final a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/q;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2

    const-string v0, "d"

    invoke-static {p1, p3, v0}, Lcom/google/android/gms/common/j;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    const/4 v1, 0x2

    invoke-static {p2, v0, v1}, Lcom/google/android/gms/common/internal/av;->a(Lcom/google/android/gms/common/api/internal/q;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/av;

    move-result-object v0

    invoke-static {p1, p3, v0, p5}, Lcom/google/android/gms/common/b;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/av;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public final b(I)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/j;->b(I)Ljava/lang/String;
