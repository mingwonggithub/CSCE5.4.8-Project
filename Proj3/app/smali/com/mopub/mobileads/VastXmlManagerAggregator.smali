...
.method private a(Lcom/mopub/mobileads/f;Ljava/util/List;)Lcom/mopub/mobileads/VastVideoConfig;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/f;->c()Ljava/util/List;
    ...
    check-cast v0, Lcom/mopub/mobileads/g;

    invoke-virtual {v0}, Lcom/mopub/mobileads/g;->k()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/f;->a()Ljava/util/List;

    move-result-object v3

    invoke-virtual {v1, v3}, Lcom/mopub/mobileads/VastVideoConfig;->addImpressionTrackers(Ljava/util/List;)V

    invoke-direct {p0, v0, v1}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/g;Lcom/mopub/mobileads/VastVideoConfig;)V

    invoke-virtual {v0}, Lcom/mopub/mobileads/g;->h()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/f;->d()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/f;->b()Ljava/util/List;
    ...
    invoke-direct {p0, p1, v1}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/c;Lcom/mopub/mobileads/VastVideoConfig;)V
...
.method private a(Lcom/mopub/mobileads/l;Ljava/util/List;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/l;->f()Ljava/lang/String;
...
.method private a(Lcom/mopub/mobileads/c;Lcom/mopub/mobileads/VastVideoConfig;)V
    .locals 4
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/mopub/mobileads/c;->e()Lcom/mopub/mobileads/VastExtensionParentXmlManager;
...
.method private a(Lcom/mopub/mobileads/g;Lcom/mopub/mobileads/VastVideoConfig;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/g;->e()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/g;->j()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/mopub/mobileads/VastVideoConfig;->getVastIconConfig()Lcom/mopub/mobileads/e;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-virtual {p1}, Lcom/mopub/mobileads/g;->l()Ljava/util/List;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->c(Ljava/util/List;)Lcom/mopub/mobileads/e;

    move-result-object v0

    invoke-virtual {p2, v0}, Lcom/mopub/mobileads/VastVideoConfig;->setVastIconConfig(Lcom/mopub/mobileads/e;)V

    :cond_1
    return-void
.end method

.method private a(Lcom/mopub/mobileads/m;Lcom/mopub/mobileads/VastVideoConfig;)V
    .locals 1
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/m;->c()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/m;->d()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/m;->e()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/mopub/mobileads/m;->g()Lcom/mopub/common/util/DeviceUtils$ForceOrientation;
...
.method private a(Ljava/util/List;Lcom/mopub/mobileads/m;Landroid/content/Context;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p2}, Lcom/mopub/mobileads/m;->b()Lcom/mopub/mobileads/VastTracker;
...
# virtual methods
.method a(IILcom/mopub/mobileads/j$b;Lcom/mopub/mobileads/VastXmlManagerAggregator$a;)Landroid/graphics/Point;
    .locals 9
    ...
    sget-object v6, Lcom/mopub/mobileads/j$b;->HTML_RESOURCE:Lcom/mopub/mobileads/j$b;
...
.method a(Ljava/util/List;Lcom/mopub/mobileads/VastXmlManagerAggregator$a;)Lcom/mopub/mobileads/VastCompanionAdConfig;
    ...
    check-cast v4, Lcom/mopub/mobileads/d;

    invoke-virtual {v4}, Lcom/mopub/mobileads/d;->a()Ljava/lang/Integer;

    move-result-object v10

    invoke-virtual {v4}, Lcom/mopub/mobileads/d;->b()Ljava/lang/Integer;
    ...
    invoke-virtual {v0, v5, v7, v1, v2}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(IILcom/mopub/mobileads/j$b;Lcom/mopub/mobileads/VastXmlManagerAggregator$a;)Landroid/graphics/Point;

    move-result-object v5

    invoke-virtual {v4}, Lcom/mopub/mobileads/d;->d()Lcom/mopub/mobileads/VastResourceXmlManager;
    ...
    invoke-static {v7, v0, v1, v2}, Lcom/mopub/mobileads/j;->a(Lcom/mopub/mobileads/VastResourceXmlManager;Lcom/mopub/mobileads/j$b;II)Lcom/mopub/mobileads/j;
    ...
    invoke-virtual {v10}, Lcom/mopub/mobileads/d;->e()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v10}, Lcom/mopub/mobileads/d;->f()Ljava/util/List;

    move-result-object v9

    invoke-virtual {v10}, Lcom/mopub/mobileads/d;->g()Ljava/util/List;

    move-result-object v10

    invoke-direct/range {v4 .. v10}, Lcom/mopub/mobileads/VastCompanionAdConfig;-><init>(IILcom/mopub/mobileads/j;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
...
.method a(Ljava/lang/String;Ljava/util/List;)Lcom/mopub/mobileads/VastVideoConfig;
    ...
    invoke-direct {v3}, Lcom/mopub/mobileads/m;-><init>()V

    :try_start_0
    invoke-virtual {v3, p1}, Lcom/mopub/mobileads/m;->a(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v3}, Lcom/mopub/mobileads/m;->a()Ljava/util/List;

    move-result-object v0

    iget-object v2, p0, Lcom/mopub/mobileads/VastXmlManagerAggregator;->e:Landroid/content/Context;

    invoke-direct {p0, v0, v3, v2}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Ljava/util/List;Lcom/mopub/mobileads/m;Landroid/content/Context;)Z
    ...
    invoke-virtual {v0}, Lcom/mopub/mobileads/b;->c()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/mopub/mobileads/b;->a()Lcom/mopub/mobileads/f;

    move-result-object v2

    if-eqz v2, :cond_2

    invoke-direct {p0, v2, p2}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/f;Ljava/util/List;)Lcom/mopub/mobileads/VastVideoConfig;

    move-result-object v2

    if-eqz v2, :cond_2

    invoke-direct {p0, v3, v2}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/m;Lcom/mopub/mobileads/VastVideoConfig;)V
    ...
    :cond_2
    invoke-virtual {v0}, Lcom/mopub/mobileads/b;->b()Lcom/mopub/mobileads/l;
    ...
    invoke-virtual {v5}, Lcom/mopub/mobileads/l;->b()Ljava/util/List;

    move-result-object v2

    invoke-interface {v0, v2}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    invoke-direct {p0, v5, v0}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/l;Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/mopub/mobileads/l;->a()Ljava/util/List;

    move-result-object v0

    invoke-virtual {v2, v0}, Lcom/mopub/mobileads/VastVideoConfig;->addImpressionTrackers(Ljava/util/List;)V

    invoke-virtual {v5}, Lcom/mopub/mobileads/l;->c()Ljava/util/List;
    ...
    invoke-direct {p0, v0, v2}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/g;Lcom/mopub/mobileads/VastVideoConfig;)V

    goto :goto_1

    :cond_3
    invoke-direct {p0, v5, v2}, Lcom/mopub/mobileads/VastXmlManagerAggregator;->a(Lcom/mopub/mobileads/c;Lcom/mopub/mobileads/VastVideoConfig;)V

    invoke-virtual {v5}, Lcom/mopub/mobileads/l;->d()Ljava/util/List;
    ...
    invoke-virtual {v0}, Lcom/mopub/mobileads/d;->h()Z

    move-result v7

    if-nez v7, :cond_7

    invoke-virtual {v0}, Lcom/mopub/mobileads/d;->f()Ljava/util/List;

    move-result-object v7

    invoke-virtual {v4, v7}, Lcom/mopub/mobileads/VastCompanionAdConfig;->addClickTrackers(Ljava/util/List;)V

    invoke-virtual {v0}, Lcom/mopub/mobileads/d;->g()Ljava/util/List;
...
.method a(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/mopub/mobileads/i;->c()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0}, Lcom/mopub/mobileads/i;->d()Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {v0}, Lcom/mopub/mobileads/i;->a()Ljava/lang/Integer;

    move-result-object v3

    invoke-virtual {v0}, Lcom/mopub/mobileads/i;->b()Ljava/lang/Integer;
...
.method b(Ljava/util/List;)Ljava/util/Map;
    ...
    check-cast v6, Lcom/mopub/mobileads/d;

    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->a()Ljava/lang/Integer;

    move-result-object v1

    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->b()Ljava/lang/Integer;
    ...
    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->c()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->d()Lcom/mopub/mobileads/VastResourceXmlManager;

    move-result-object v0

    sget-object v3, Lcom/mopub/mobileads/j$b;->HTML_RESOURCE:Lcom/mopub/mobileads/j$b;
    ...
    invoke-static {v0, v3, v4, v5}, Lcom/mopub/mobileads/j;->a(Lcom/mopub/mobileads/VastResourceXmlManager;Lcom/mopub/mobileads/j$b;II)Lcom/mopub/mobileads/j;
    ...
    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->e()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->f()Ljava/util/List;

    move-result-object v5

    invoke-virtual {v6}, Lcom/mopub/mobileads/d;->g()Ljava/util/List;

    move-result-object v6

    invoke-direct/range {v0 .. v6}, Lcom/mopub/mobileads/VastCompanionAdConfig;-><init>(IILcom/mopub/mobileads/j;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
...
.method c(Ljava/util/List;)Lcom/mopub/mobileads/e;
    .locals 11
    .annotation build Lcom/mopub/common/VisibleForTesting;
    .end annotation
    ...
    invoke-static {v9, v6, v0, v5}, Lcom/mopub/mobileads/j;->a(Lcom/mopub/mobileads/VastResourceXmlManager;Lcom/mopub/mobileads/j$b;II)Lcom/mopub/mobileads/j;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/mopub/mobileads/e;-><init>(IILjava/lang/Integer;Ljava/lang/Integer;Lcom/mopub/mobileads/j;Ljava/util/List;Ljava/lang/String;Ljava/util/List;)V
