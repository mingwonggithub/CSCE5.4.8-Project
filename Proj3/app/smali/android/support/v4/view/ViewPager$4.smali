...
.method public a(Landroid/view/View;Landroid/support/v4/view/az;)Landroid/support/v4/view/az;
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/az;->e()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/az;->a()I

    move-result v1

    iput v1, v2, Landroid/graphics/Rect;->left:I

    invoke-virtual {v0}, Landroid/support/v4/view/az;->b()I

    move-result v1

    iput v1, v2, Landroid/graphics/Rect;->top:I

    invoke-virtual {v0}, Landroid/support/v4/view/az;->c()I

    move-result v1

    iput v1, v2, Landroid/graphics/Rect;->right:I

    invoke-virtual {v0}, Landroid/support/v4/view/az;->d()I
    ...
    invoke-static {v4, v0}, Landroid/support/v4/view/ae;->b(Landroid/view/View;Landroid/support/v4/view/az;)Landroid/support/v4/view/az;

    move-result-object v4

    invoke-virtual {v4}, Landroid/support/v4/view/az;->a()I
    ...
    invoke-virtual {v4}, Landroid/support/v4/view/az;->b()I
    ...
    invoke-virtual {v4}, Landroid/support/v4/view/az;->c()I
    ...
    invoke-virtual {v4}, Landroid/support/v4/view/az;->d()I
    ...
    invoke-virtual {v0, v1, v3, v4, v2}, Landroid/support/v4/view/az;->a(IIII)Landroid/support/v4/view/az;
