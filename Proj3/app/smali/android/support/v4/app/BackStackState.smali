...
.method public constructor <init>(Landroid/support/v4/app/m;)V
    ...
    iget-object v1, p1, Landroid/support/v4/app/m;->c:Ljava/util/ArrayList;
    ...
    iget-boolean v1, p1, Landroid/support/v4/app/m;->j:Z
    ...
    iget-object v0, p1, Landroid/support/v4/app/m;->c:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v4/app/m$a;->a:I
    ...
    iget v6, v0, Landroid/support/v4/app/m$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/app/m$a;->e:I
    ...
    :cond_2
    iget v0, p1, Landroid/support/v4/app/m;->h:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->b:I

    iget v0, p1, Landroid/support/v4/app/m;->i:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iget-object v0, p1, Landroid/support/v4/app/m;->l:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iget v0, p1, Landroid/support/v4/app/m;->n:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iget v0, p1, Landroid/support/v4/app/m;->o:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iget-object v0, p1, Landroid/support/v4/app/m;->p:Ljava/lang/CharSequence;
    ...
    iget-object v0, p1, Landroid/support/v4/app/m;->s:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iget-object v0, p1, Landroid/support/v4/app/m;->t:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iget-boolean v0, p1, Landroid/support/v4/app/m;->u:Z
...
.method public a(Landroid/support/v4/app/z;)Landroid/support/v4/app/m;
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/m;-><init>(Landroid/support/v4/app/z;)V
    ...
    new-instance v4, Landroid/support/v4/app/m$a;

    invoke-direct {v4}, Landroid/support/v4/app/m$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/app/m$a;->a:I
    ...
    iget-object v5, p1, Landroid/support/v4/app/z;->e:Ljava/util/ArrayList;
    ...
    iput-object v0, v4, Landroid/support/v4/app/m$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v4, Landroid/support/v4/app/m$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/app/m$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/app/m$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/app/m$a;->f:I

    iget v0, v4, Landroid/support/v4/app/m$a;->c:I

    iput v0, v3, Landroid/support/v4/app/m;->d:I

    iget v0, v4, Landroid/support/v4/app/m$a;->d:I

    iput v0, v3, Landroid/support/v4/app/m;->e:I

    iget v0, v4, Landroid/support/v4/app/m$a;->e:I

    iput v0, v3, Landroid/support/v4/app/m;->f:I

    iget v0, v4, Landroid/support/v4/app/m$a;->f:I

    iput v0, v3, Landroid/support/v4/app/m;->g:I

    invoke-virtual {v3, v4}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/m$a;)V
    ...
    iput v0, v3, Landroid/support/v4/app/m;->h:I

    iget v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput v0, v3, Landroid/support/v4/app/m;->i:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/m;->l:Ljava/lang/String;

    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/m;->n:I

    iput-boolean v7, v3, Landroid/support/v4/app/m;->j:Z

    iget v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v0, v3, Landroid/support/v4/app/m;->o:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/m;->p:Ljava/lang/CharSequence;

    iget v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v0, v3, Landroid/support/v4/app/m;->q:I

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/m;->r:Ljava/lang/CharSequence;

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/m;->s:Ljava/util/ArrayList;

    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/m;->t:Ljava/util/ArrayList;

    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/m;->u:Z

    invoke-virtual {v3, v7}, Landroid/support/v4/app/m;->a(I)V
