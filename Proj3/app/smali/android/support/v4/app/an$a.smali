.class public Landroid/support/v4/app/an$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/lang/String;Ljava/util/ArrayList;Landroid/os/Bundle;IILandroid/app/Notification;Ljava/lang/String;ZLjava/lang/String;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/an$a;->a:Landroid/app/Notification$Builder;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Landroid/support/v4/app/an$a;->b:Landroid/os/Bundle;

    if-eqz p21, :cond_0

    iget-object v4, p0, Landroid/support/v4/app/an$a;->b:Landroid/os/Bundle;
    ...
    iget-object v6, p0, Landroid/support/v4/app/an$a;->a:Landroid/app/Notification$Builder;
    ...
    iput-object v0, p0, Landroid/support/v4/app/an$a;->c:Landroid/widget/RemoteViews;

    move-object/from16 v0, p29

    iput-object v0, p0, Landroid/support/v4/app/an$a;->d:Landroid/widget/RemoteViews;

    move-object/from16 v0, p30

    iput-object v0, p0, Landroid/support/v4/app/an$a;->e:Landroid/widget/RemoteViews;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, Landroid/support/v4/app/an$a;->a:Landroid/app/Notification$Builder;
...
.method public a(Landroid/support/v4/app/ap$a;)V
    ...
    invoke-static {v0, p1}, Landroid/support/v4/app/am;->a(Landroid/app/Notification$Builder;Landroid/support/v4/app/ap$a;)V
...
.method public b()Landroid/app/Notification;
    ...
    iget-object v1, p0, Landroid/support/v4/app/an$a;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/app/an$a;->c:Landroid/widget/RemoteViews;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/an$a;->d:Landroid/widget/RemoteViews;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v4/app/an$a;->e:Landroid/widget/RemoteViews;
