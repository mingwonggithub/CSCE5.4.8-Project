.class Landroid/support/v4/app/ag$c;
...
.method public a(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    invoke-static {p1}, Landroid/support/v4/app/ah;->a(Landroid/app/Activity;)Landroid/content/Intent;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Landroid/support/v4/app/ag$c;->b(Landroid/app/Activity;)Landroid/content/Intent;
...
.method public a(Landroid/content/Context;Landroid/content/pm/ActivityInfo;)Ljava/lang/String;
    ...
    invoke-static {p2}, Landroid/support/v4/app/ah;->a(Landroid/content/pm/ActivityInfo;)Ljava/lang/String;
...
.method public a(Landroid/app/Activity;Landroid/content/Intent;)Z
    ...
    invoke-static {p1, p2}, Landroid/support/v4/app/ah;->a(Landroid/app/Activity;Landroid/content/Intent;)Z
...
.method public b(Landroid/app/Activity;Landroid/content/Intent;)V
    ...
    invoke-static {p1, p2}, Landroid/support/v4/app/ah;->b(Landroid/app/Activity;Landroid/content/Intent;)V
