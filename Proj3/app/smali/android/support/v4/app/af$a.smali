...
# interfaces
.implements Landroid/support/v4/b/h$a;
.implements Landroid/support/v4/b/h$b;
...
.field d:Landroid/support/v4/b/h;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/ae$a;->a(ILandroid/os/Bundle;)Landroid/support/v4/b/h;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;
    ...
    iget-object v2, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/b/h;->a(ILandroid/support/v4/b/h$b;)V

    iget-object v0, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;

    invoke-virtual {v0, p0}, Landroid/support/v4/b/h;->a(Landroid/support/v4/b/h$a;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/b/h;->a()V

    goto/16 :goto_0
.end method

.method a(Landroid/support/v4/b/h;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, v1, Landroid/support/v4/app/af;->g:Landroid/support/v4/app/x;

    if-eqz v1, :cond_4

    iget-object v0, p0, Landroid/support/v4/app/af$a;->o:Landroid/support/v4/app/af;

    iget-object v0, v0, Landroid/support/v4/app/af;->g:Landroid/support/v4/app/x;
    ...
    iget-object v1, v1, Landroid/support/v4/app/x;->d:Landroid/support/v4/app/z;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v4/b/h;->a(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/ae$a;->a(Landroid/support/v4/b/h;Ljava/lang/Object;)V
    :try_end_0
    ...
    iget-object v2, v2, Landroid/support/v4/app/af;->g:Landroid/support/v4/app/x;
    ...
    iget-object v2, v2, Landroid/support/v4/app/x;->d:Landroid/support/v4/app/z;
...
.method public a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p2, p3, p4}, Landroid/support/v4/b/h;->a(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method c()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/af$a;->a(Landroid/support/v4/b/h;Ljava/lang/Object;)V
...
.method e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/b/h;->a(Landroid/support/v4/b/h$b;)V

    iget-object v0, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;

    invoke-virtual {v0, p0}, Landroid/support/v4/b/h;->b(Landroid/support/v4/b/h$a;)V
...
.method f()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;
    ...
    iget-object v3, p0, Landroid/support/v4/app/af$a;->d:Landroid/support/v4/b/h;

    invoke-interface {v0, v3}, Landroid/support/v4/app/ae$a;->a(Landroid/support/v4/b/h;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0}, Landroid/support/v4/b/h;->e()V
