...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/a/b$a;->M:Z

    iput-object p1, p0, Landroid/support/v7/a/b$a;->a:Landroid/content/Context;

    iput-boolean v1, p0, Landroid/support/v7/a/b$a;->o:Z
    ...
    iput-object v0, p0, Landroid/support/v7/a/b$a;->b:Landroid/view/LayoutInflater;
...
.method private b(Landroid/support/v7/a/b;)V
    ...
    iget v1, p1, Landroid/support/v7/a/b;->l:I
    ...
    iget-boolean v0, p0, Landroid/support/v7/a/b$a;->D:Z
    ...
    new-instance v0, Landroid/support/v7/a/b$a$1;

    iget-object v2, p0, Landroid/support/v7/a/b$a;->a:Landroid/content/Context;

    iget v3, p1, Landroid/support/v7/a/b;->m:I

    iget-object v5, p0, Landroid/support/v7/a/b$a;->s:[Ljava/lang/CharSequence;

    move-object v1, p0

    invoke-direct/range {v0 .. v6}, Landroid/support/v7/a/b$a$1;-><init>(Landroid/support/v7/a/b$a;Landroid/content/Context;II[Ljava/lang/CharSequence;Landroid/widget/ListView;)V
    ...
    invoke-interface {v1, v6}, Landroid/support/v7/a/b$a$a;->a(Landroid/widget/ListView;)V

    :cond_0
    iput-object v0, p1, Landroid/support/v7/a/b;->j:Landroid/widget/ListAdapter;

    iget v0, p0, Landroid/support/v7/a/b$a;->F:I

    iput v0, p1, Landroid/support/v7/a/b;->k:I

    iget-object v0, p0, Landroid/support/v7/a/b$a;->u:Landroid/content/DialogInterface$OnClickListener;

    if-eqz v0, :cond_9

    new-instance v0, Landroid/support/v7/a/b$a$3;

    invoke-direct {v0, p0, p1}, Landroid/support/v7/a/b$a$3;-><init>(Landroid/support/v7/a/b$a;Landroid/support/v7/a/b;)V

    invoke-virtual {v6, v0}, Landroid/widget/ListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    :cond_1
    :goto_1
    iget-object v0, p0, Landroid/support/v7/a/b$a;->K:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    :cond_2
    iget-boolean v0, p0, Landroid/support/v7/a/b$a;->E:Z
    ...
    :cond_3
    :goto_2
    iput-object v6, p1, Landroid/support/v7/a/b;->b:Landroid/widget/ListView;

    return-void

    :cond_4
    new-instance v1, Landroid/support/v7/a/b$a$2;
    ...
    iget v2, p1, Landroid/support/v7/a/b;->n:I
    ...
    iget-object v3, p0, Landroid/support/v7/a/b$a;->H:Landroid/database/Cursor;

    new-array v7, v9, [Ljava/lang/String;

    iget-object v8, p0, Landroid/support/v7/a/b$a;->I:Ljava/lang/String;
    ...
    :cond_6
    iget v2, p1, Landroid/support/v7/a/b;->o:I
    ...
    invoke-direct {v0, v1, v2, v4, v3}, Landroid/support/v7/a/b$c;-><init>(Landroid/content/Context;II[Ljava/lang/CharSequence;)V

    goto :goto_0

    :cond_9
    iget-object v0, p0, Landroid/support/v7/a/b$a;->G:Landroid/content/DialogInterface$OnMultiChoiceClickListener;

    if-eqz v0, :cond_1

    new-instance v0, Landroid/support/v7/a/b$a$4;

    invoke-direct {v0, p0, v6, p1}, Landroid/support/v7/a/b$a$4;-><init>(Landroid/support/v7/a/b$a;Landroid/widget/ListView;Landroid/support/v7/a/b;)V
...
.method public a(Landroid/support/v7/a/b;)V
    ...
    iget-object v1, p0, Landroid/support/v7/a/b$a;->i:Ljava/lang/CharSequence;

    iget-object v2, p0, Landroid/support/v7/a/b$a;->j:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {p1, v0, v1, v2, v3}, Landroid/support/v7/a/b;->a(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;)V
    ...
    iget-object v1, p0, Landroid/support/v7/a/b$a;->k:Ljava/lang/CharSequence;

    iget-object v2, p0, Landroid/support/v7/a/b$a;->l:Landroid/content/DialogInterface$OnClickListener;
    ...
    iget-object v1, p0, Landroid/support/v7/a/b$a;->m:Ljava/lang/CharSequence;

    iget-object v2, p0, Landroid/support/v7/a/b$a;->n:Landroid/content/DialogInterface$OnClickListener;
    ...
    iget-object v1, p0, Landroid/support/v7/a/b$a;->w:Landroid/view/View;

    iget v2, p0, Landroid/support/v7/a/b$a;->x:I

    iget v3, p0, Landroid/support/v7/a/b$a;->y:I

    iget v4, p0, Landroid/support/v7/a/b$a;->z:I

    iget v5, p0, Landroid/support/v7/a/b$a;->A:I
