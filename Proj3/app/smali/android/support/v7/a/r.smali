...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/r;->f:Ljava/util/ArrayList;

    new-instance v0, Landroid/support/v7/a/r$1;

    invoke-direct {v0, p0}, Landroid/support/v7/a/r$1;-><init>(Landroid/support/v7/a/r;)V

    iput-object v0, p0, Landroid/support/v7/a/r;->h:Ljava/lang/Runnable;

    new-instance v0, Landroid/support/v7/a/r$2;

    invoke-direct {v0, p0}, Landroid/support/v7/a/r$2;-><init>(Landroid/support/v7/a/r;)V

    iput-object v0, p0, Landroid/support/v7/a/r;->i:Landroid/support/v7/widget/Toolbar$c;

    new-instance v0, Landroid/support/v7/widget/bo;

    const/4 v1, 0x0

    invoke-direct {v0, p1, v1}, Landroid/support/v7/widget/bo;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/a/r;->a:Landroid/support/v7/widget/ah;

    new-instance v0, Landroid/support/v7/a/r$d;

    invoke-direct {v0, p0, p3}, Landroid/support/v7/a/r$d;-><init>(Landroid/support/v7/a/r;Landroid/view/Window$Callback;)V

    iput-object v0, p0, Landroid/support/v7/a/r;->c:Landroid/view/Window$Callback;

    iget-object v0, p0, Landroid/support/v7/a/r;->a:Landroid/support/v7/widget/ah;

    iget-object v1, p0, Landroid/support/v7/a/r;->c:Landroid/view/Window$Callback;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/ah;->a(Landroid/view/Window$Callback;)V

    iget-object v0, p0, Landroid/support/v7/a/r;->i:Landroid/support/v7/widget/Toolbar$c;
...
.method private b(Landroid/view/Menu;)V
    ...
    iget-object v0, p0, Landroid/support/v7/a/r;->g:Landroid/support/v7/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/a/r;->g:Landroid/support/v7/view/menu/f;

    iget-object v0, p0, Landroid/support/v7/a/r;->g:Landroid/support/v7/view/menu/f;

    new-instance v1, Landroid/support/v7/a/r$c;

    invoke-direct {v1, p0}, Landroid/support/v7/a/r$c;-><init>(Landroid/support/v7/a/r;)V
...
.method private k()Landroid/view/Menu;
    ...
    new-instance v1, Landroid/support/v7/a/r$a;

    invoke-direct {v1, p0}, Landroid/support/v7/a/r$a;-><init>(Landroid/support/v7/a/r;)V

    new-instance v2, Landroid/support/v7/a/r$b;

    invoke-direct {v2, p0}, Landroid/support/v7/a/r$b;-><init>(Landroid/support/v7/a/r;)V
...
.method a(Landroid/view/Menu;)Landroid/view/View;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/a/r;->b(Landroid/view/Menu;)V

    if-eqz p1, :cond_0

    iget-object v1, p0, Landroid/support/v7/a/r;->g:Landroid/support/v7/view/menu/f;
    ...
    iget-object v1, p0, Landroid/support/v7/a/r;->a:Landroid/support/v7/widget/ah;

    invoke-interface {v1}, Landroid/support/v7/widget/ah;->a()Landroid/view/ViewGroup;
...
.method public a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v7/a/r;->k()Landroid/view/Menu;
...
.method public b()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ah;->q()I
...
.method public e()Z
    ...
    iget-object v1, p0, Landroid/support/v7/a/r;->h:Ljava/lang/Runnable;
...
.method public g(Z)V
    ...
    :cond_1
    iput-boolean p1, p0, Landroid/support/v7/a/r;->e:Z

    iget-object v0, p0, Landroid/support/v7/a/r;->f:Ljava/util/ArrayList;
...
.method public i()Landroid/view/Window$Callback;
    ...
    iget-object v0, p0, Landroid/support/v7/a/r;->c:Landroid/view/Window$Callback;
