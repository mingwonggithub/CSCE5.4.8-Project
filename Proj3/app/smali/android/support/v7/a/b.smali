...
.field final a:Landroid/support/v7/a/m;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/a/m;Landroid/view/Window;)V
    ...
    iput-boolean v3, p0, Landroid/support/v7/a/b;->A:Z

    iput v3, p0, Landroid/support/v7/a/b;->E:I

    const/4 v0, -0x1

    iput v0, p0, Landroid/support/v7/a/b;->k:I

    iput v3, p0, Landroid/support/v7/a/b;->M:I
    ...
    iput-object p1, p0, Landroid/support/v7/a/b;->q:Landroid/content/Context;

    iput-object p2, p0, Landroid/support/v7/a/b;->a:Landroid/support/v7/a/m;

    iput-object p3, p0, Landroid/support/v7/a/b;->r:Landroid/view/Window;
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->p:Landroid/os/Handler;
    ...
    iput v1, p0, Landroid/support/v7/a/b;->L:I
    ...
    iput v1, p0, Landroid/support/v7/a/b;->m:I
    ...
    iput v1, p0, Landroid/support/v7/a/b;->n:I
    ...
    iput v1, p0, Landroid/support/v7/a/b;->o:I

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    const/4 v0, 0x1

    invoke-virtual {p2, v0}, Landroid/support/v7/a/m;->c(I)Z
...
.method private a(Landroid/view/ViewGroup;)V
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->u:Landroid/view/View;
    ...
    :cond_1
    iget-object v2, p0, Landroid/support/v7/a/b;->r:Landroid/view/Window;
    ...
    iget-object v0, p0, Landroid/support/v7/a/b;->r:Landroid/view/Window;
    ...
    iget-boolean v1, p0, Landroid/support/v7/a/b;->A:Z

    if-eqz v1, :cond_3

    iget v1, p0, Landroid/support/v7/a/b;->w:I

    iget v2, p0, Landroid/support/v7/a/b;->x:I

    iget v3, p0, Landroid/support/v7/a/b;->y:I

    iget v4, p0, Landroid/support/v7/a/b;->z:I

    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/widget/FrameLayout;->setPadding(IIII)V

    :cond_3
    iget-object v0, p0, Landroid/support/v7/a/b;->b:Landroid/widget/ListView;
    ...
    :cond_5
    iget v1, p0, Landroid/support/v7/a/b;->v:I

    if-eqz v1, :cond_6

    iget-object v1, p0, Landroid/support/v7/a/b;->q:Landroid/content/Context;

    invoke-static {v1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v1

    iget v2, p0, Landroid/support/v7/a/b;->v:I
...
.method private a(Landroid/view/ViewGroup;Landroid/view/View;II)V
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->r:Landroid/view/Window;
    ...
    :cond_4
    iget-object v1, p0, Landroid/support/v7/a/b;->t:Ljava/lang/CharSequence;

    if-eqz v1, :cond_5

    iget-object v1, p0, Landroid/support/v7/a/b;->i:Landroid/support/v4/widget/NestedScrollView;
    ...
    :cond_5
    iget-object v1, p0, Landroid/support/v7/a/b;->b:Landroid/widget/ListView;
...
.method private b()I
    ...
    :cond_0
    iget v0, p0, Landroid/support/v7/a/b;->M:I
...
.method private b(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroid/support/v7/a/b;->J:Landroid/view/View;
    ...
    iget-object v2, p0, Landroid/support/v7/a/b;->J:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;

    iget-object v0, p0, Landroid/support/v7/a/b;->s:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->H:Landroid/widget/TextView;

    iget-object v0, p0, Landroid/support/v7/a/b;->H:Landroid/widget/TextView;

    iget-object v1, p0, Landroid/support/v7/a/b;->s:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v7/a/b;->F:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_3

    iget-object v0, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;

    iget-object v1, p0, Landroid/support/v7/a/b;->F:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;

    invoke-virtual {v1}, Landroid/widget/ImageView;->getPaddingLeft()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;

    invoke-virtual {v2}, Landroid/widget/ImageView;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;

    invoke-virtual {v3}, Landroid/widget/ImageView;->getPaddingRight()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/a/b;->G:Landroid/widget/ImageView;
...
.method private c()V
    ...
    iget-object v4, p0, Landroid/support/v7/a/b;->i:Landroid/support/v4/widget/NestedScrollView;
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->j:Landroid/widget/ListAdapter;
    ...
    iget v1, p0, Landroid/support/v7/a/b;->k:I
    ...
    :cond_7
    iget-object v0, p0, Landroid/support/v7/a/b;->i:Landroid/support/v4/widget/NestedScrollView;
...
.method private c(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->i:Landroid/support/v4/widget/NestedScrollView;
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->I:Landroid/widget/TextView;

    iget-object v0, p0, Landroid/support/v7/a/b;->I:Landroid/widget/TextView;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/a/b;->t:Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->I:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroid/support/v7/a/b;->b:Landroid/widget/ListView;
...
.method private d(Landroid/view/ViewGroup;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->c:Landroid/widget/Button;

    iget-object v0, p0, Landroid/support/v7/a/b;->c:Landroid/widget/Button;

    iget-object v1, p0, Landroid/support/v7/a/b;->N:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v1}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Landroid/support/v7/a/b;->B:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->e:Landroid/widget/Button;

    iget-object v0, p0, Landroid/support/v7/a/b;->e:Landroid/widget/Button;

    iget-object v6, p0, Landroid/support/v7/a/b;->N:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v6}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v0, p0, Landroid/support/v7/a/b;->C:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->g:Landroid/widget/Button;

    iget-object v0, p0, Landroid/support/v7/a/b;->g:Landroid/widget/Button;
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->B:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, Landroid/support/v7/a/b;->C:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Landroid/support/v7/a/b;->D:Ljava/lang/CharSequence;
...
.method public a()V
    ...
    iget-object v1, p0, Landroid/support/v7/a/b;->a:Landroid/support/v7/a/m;
...
.method public a(I)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->u:Landroid/view/View;

    iput p1, p0, Landroid/support/v7/a/b;->v:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/a/b;->A:Z
...
.method public a(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;)V
    ...
    iget-object v0, p0, Landroid/support/v7/a/b;->p:Landroid/os/Handler;
    ...
    :pswitch_0
    iput-object p2, p0, Landroid/support/v7/a/b;->B:Ljava/lang/CharSequence;

    iput-object p4, p0, Landroid/support/v7/a/b;->d:Landroid/os/Message;

    :goto_0
    return-void

    :pswitch_1
    iput-object p2, p0, Landroid/support/v7/a/b;->C:Ljava/lang/CharSequence;

    iput-object p4, p0, Landroid/support/v7/a/b;->f:Landroid/os/Message;

    goto :goto_0

    :pswitch_2
    iput-object p2, p0, Landroid/support/v7/a/b;->D:Ljava/lang/CharSequence;

    iput-object p4, p0, Landroid/support/v7/a/b;->h:Landroid/os/Message;
...
.method public a(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroid/support/v7/a/b;->F:Landroid/graphics/drawable/Drawable;
...
.method public a(Landroid/view/View;IIII)V
    ...
    iput-object p1, p0, Landroid/support/v7/a/b;->u:Landroid/view/View;

    const/4 v0, 0x0

    iput v0, p0, Landroid/support/v7/a/b;->v:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/a/b;->A:Z

    iput p2, p0, Landroid/support/v7/a/b;->w:I

    iput p3, p0, Landroid/support/v7/a/b;->x:I

    iput p4, p0, Landroid/support/v7/a/b;->y:I

    iput p5, p0, Landroid/support/v7/a/b;->z:I
...
.method public a(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/a/b;->s:Ljava/lang/CharSequence;
...
.method public b(I)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/b;->F:Landroid/graphics/drawable/Drawable;
...
.method public b(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/v7/a/b;->J:Landroid/view/View;
...
.method public b(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/a/b;->t:Ljava/lang/CharSequence;
