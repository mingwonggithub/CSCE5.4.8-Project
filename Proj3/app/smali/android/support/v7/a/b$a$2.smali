...
.method constructor <init>(Landroid/support/v7/a/b$a;Landroid/content/Context;Landroid/database/Cursor;ZLandroid/widget/ListView;Landroid/support/v7/a/b;)V
    ...
    iget-object v1, p0, Landroid/support/v7/a/b$a$2;->c:Landroid/support/v7/a/b$a;

    iget-object v1, v1, Landroid/support/v7/a/b$a;->I:Ljava/lang/String;

    invoke-interface {v0, v1}, Landroid/database/Cursor;->getColumnIndexOrThrow(Ljava/lang/String;)I

    move-result v1

    iput v1, p0, Landroid/support/v7/a/b$a$2;->d:I

    iget-object v1, p0, Landroid/support/v7/a/b$a$2;->c:Landroid/support/v7/a/b$a;

    iget-object v1, v1, Landroid/support/v7/a/b$a;->J:Ljava/lang/String;

    invoke-interface {v0, v1}, Landroid/database/Cursor;->getColumnIndexOrThrow(Ljava/lang/String;)I

    move-result v0

    iput v0, p0, Landroid/support/v7/a/b$a$2;->e:I
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget v2, p0, Landroid/support/v7/a/b$a$2;->d:I
    ...
    iget-object v2, p0, Landroid/support/v7/a/b$a$2;->a:Landroid/widget/ListView;
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/a/b$a$2;->c:Landroid/support/v7/a/b$a;

    iget-object v0, v0, Landroid/support/v7/a/b$a;->b:Landroid/view/LayoutInflater;

    iget-object v1, p0, Landroid/support/v7/a/b$a$2;->b:Landroid/support/v7/a/b;

    iget v1, v1, Landroid/support/v7/a/b;->m:I
