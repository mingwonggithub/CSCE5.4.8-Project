...
.method private static a(I)I
    ...
    sget v0, Landroid/support/v7/b/a$h;->notification_template_big_media_narrow:I

    :goto_0
    return v0

    :cond_0
    sget v0, Landroid/support/v7/b/a$h;->notification_template_big_media:I

    goto :goto_0
.end method

.method private static a(Landroid/content/Context;Landroid/support/v4/app/ap$a;)Landroid/widget/RemoteViews;
    .locals 4

    invoke-virtual {p1}, Landroid/support/v4/app/ap$a;->c()Landroid/app/PendingIntent;
    ...
    sget v3, Landroid/support/v7/b/a$h;->notification_media_action:I

    invoke-direct {v1, v2, v3}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    sget v2, Landroid/support/v7/b/a$f;->action0:I

    invoke-virtual {p1}, Landroid/support/v4/app/ap$a;->a()I
    ...
    sget v0, Landroid/support/v7/b/a$f;->action0:I
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/ap$a;->b()Ljava/lang/CharSequence;
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;
    ...
    sget v5, Landroid/support/v7/b/a$f;->icon:I
    ...
    sget v5, Landroid/support/v7/b/a$f;->title:I
    ...
    sget v4, Landroid/support/v7/b/a$f;->text:I
    ...
    sget v4, Landroid/support/v7/b/a$f;->info:I
    ...
    sget v3, Landroid/support/v7/b/a$f;->text2:I
    ...
    sget v4, Landroid/support/v7/b/a$d;->notification_subtext_size:I
    ...
    :cond_3
    sget v3, Landroid/support/v7/b/a$f;->line1:I
    ...
    sget v3, Landroid/support/v7/b/a$f;->chronometer:I
    ...
    :cond_5
    :goto_3
    sget v4, Landroid/support/v7/b/a$f;->line3:I
    ...
    sget v5, Landroid/support/v7/b/a$g;->status_bar_notification_info_maxnum:I
    ...
    sget v6, Landroid/support/v7/b/a$i;->status_bar_notification_info_overflow:I
    ...
    sget v5, Landroid/support/v7/b/a$f;->info:I
    ...
    :cond_a
    sget v4, Landroid/support/v7/b/a$f;->text2:I
    ...
    :cond_b
    sget v3, Landroid/support/v7/b/a$f;->time:I
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v14}, Landroid/support/v7/a/q;->a(I)I
    ...
    invoke-static/range {v2 .. v13}, Landroid/support/v7/a/q;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;

    move-result-object v4

    sget v2, Landroid/support/v7/b/a$f;->media_actions:I
    ...
    check-cast v2, Landroid/support/v4/app/ap$a;

    move-object/from16 v0, p0

    invoke-static {v0, v2}, Landroid/support/v7/a/q;->a(Landroid/content/Context;Landroid/support/v4/app/ap$a;)Landroid/widget/RemoteViews;

    move-result-object v2

    sget v5, Landroid/support/v7/b/a$f;->media_actions:I
    ...
    sget v2, Landroid/support/v7/b/a$f;->cancel_action:I
    ...
    sget v6, Landroid/support/v7/b/a$g;->cancel_button_image_alpha:I
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    sget v12, Landroid/support/v7/b/a$h;->notification_template_media:I
    ...
    invoke-static {p0, v2}, Landroid/support/v7/a/q;->a(Landroid/content/Context;Landroid/support/v4/app/ap$a;)Landroid/widget/RemoteViews;

    move-result-object v2

    sget v7, Landroid/support/v7/b/a$f;->media_actions:I
    ...
    sget v2, Landroid/support/v7/b/a$f;->end_padder:I
...
.method public static a(Landroid/app/Notification;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)V
    ...
    invoke-static/range {p1 .. p13}, Landroid/support/v7/a/q;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
...
.method public static a(Landroid/support/v4/app/ak;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {p1 .. p14}, Landroid/support/v7/a/q;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;

    move-result-object v0

    invoke-interface {p0}, Landroid/support/v4/app/ak;->a()Landroid/app/Notification$Builder;
