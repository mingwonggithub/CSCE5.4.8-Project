...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/a/g;->n:Z

    sget-boolean v0, Landroid/support/v7/a/g;->n:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Landroid/support/v7/a/g;->m:Z
    ...
    new-instance v3, Landroid/support/v7/a/g$1;

    invoke-direct {v3, v0}, Landroid/support/v7/a/g$1;-><init>(Ljava/lang/Thread$UncaughtExceptionHandler;)V

    invoke-static {v3}, Ljava/lang/Thread;->setDefaultUncaughtExceptionHandler(Ljava/lang/Thread$UncaughtExceptionHandler;)V

    sput-boolean v1, Landroid/support/v7/a/g;->m:Z
    ...
    sput-object v0, Landroid/support/v7/a/g;->o:[I
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/a/e;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/g;->c:Landroid/view/Window$Callback;

    iget-object v0, p0, Landroid/support/v7/a/g;->c:Landroid/view/Window$Callback;

    instance-of v0, v0, Landroid/support/v7/a/g$a;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/a/g;->a(Landroid/view/Window$Callback;)Landroid/view/Window$Callback;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/a/g;->d:Landroid/view/Window$Callback;

    iget-object v0, p0, Landroid/support/v7/a/g;->b:Landroid/view/Window;

    iget-object v1, p0, Landroid/support/v7/a/g;->d:Landroid/view/Window$Callback;

    invoke-virtual {v0, v1}, Landroid/view/Window;->setCallback(Landroid/view/Window$Callback;)V

    const/4 v0, 0x0

    sget-object v1, Landroid/support/v7/a/g;->o:[I

    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/bn;->a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/bn;
    ...
    iget-object v2, p0, Landroid/support/v7/a/g;->b:Landroid/view/Window;
...
.method public a()Landroid/support/v7/a/a;
    ...
    invoke-virtual {p0}, Landroid/support/v7/a/g;->l()V
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/a/g;->p:Ljava/lang/CharSequence;
...
.method public b()Landroid/view/MenuInflater;
    ...
    iput-object v1, p0, Landroid/support/v7/a/g;->g:Landroid/view/MenuInflater;
...
.method public c()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/a/g;->q:Z
...
.method public g()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/a/g;->r:Z
...
.method final p()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/a/g;->r:Z
...
.method final r()Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/a/g;->p:Ljava/lang/CharSequence;
