...
# static fields
.field private static d:Landroid/support/v7/a/s;
...
.method static a()Landroid/support/v7/a/s;
    .locals 1

    sget-object v0, Landroid/support/v7/a/s;->d:Landroid/support/v7/a/s;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/a/s;

    invoke-direct {v0}, Landroid/support/v7/a/s;-><init>()V

    sput-object v0, Landroid/support/v7/a/s;->d:Landroid/support/v7/a/s;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/a/s;->c:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/s;->a:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/s;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/a/s;->a:J
    ...
    iget-wide v2, p0, Landroid/support/v7/a/s;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/a/s;->a:J
