...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v7}, Landroid/support/v7/widget/m$b;-><init>(I)V
    ...
    sget v1, Landroid/support/v7/b/a$e;->abc_seekbar_tick_mark_material:I

    aput v1, v0, v4

    sget v1, Landroid/support/v7/b/a$e;->abc_ic_menu_share_mtrl_alpha:I

    aput v1, v0, v5

    sget v1, Landroid/support/v7/b/a$e;->abc_ic_menu_copy_mtrl_am_alpha:I
    ...
    sget v1, Landroid/support/v7/b/a$e;->abc_ic_menu_paste_mtrl_am_alpha:I
    ...
    sget v2, Landroid/support/v7/b/a$e;->abc_text_select_handle_left_mtrl_dark:I

    aput v2, v0, v1

    const/4 v1, 0x5

    sget v2, Landroid/support/v7/b/a$e;->abc_text_select_handle_middle_mtrl_dark:I

    aput v2, v0, v1

    sget v1, Landroid/support/v7/b/a$e;->abc_text_select_handle_right_mtrl_dark:I

    aput v1, v0, v7

    const/4 v1, 0x7

    sget v2, Landroid/support/v7/b/a$e;->abc_text_select_handle_left_mtrl_light:I

    aput v2, v0, v1

    const/16 v1, 0x8

    sget v2, Landroid/support/v7/b/a$e;->abc_text_select_handle_middle_mtrl_light:I

    aput v2, v0, v1

    const/16 v1, 0x9

    sget v2, Landroid/support/v7/b/a$e;->abc_text_select_handle_right_mtrl_light:I
...
.method private a(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, v0, p2}, Landroid/support/v7/widget/m;->c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p4}, Landroid/support/v7/widget/aj;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_3
    sget v0, Landroid/support/v7/b/a$e;->abc_ratingbar_material:I
...
.method private static a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/aj;->c(Landroid/graphics/drawable/Drawable;)Z
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bl;[I)V
    .locals 2
    ...
    :cond_1
    iget-boolean v0, p1, Landroid/support/v7/widget/bl;->e:Z

    if-nez v0, :cond_2

    iget-boolean v0, p1, Landroid/support/v7/widget/bl;->d:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/bl;->b:Landroid/content/res/ColorStateList;

    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/bl;->d:Z

    if-eqz v1, :cond_4

    iget-object v1, p1, Landroid/support/v7/widget/bl;->c:Landroid/graphics/PorterDuff$Mode;
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/m$c;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/m;->k:Landroid/support/v4/f/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/m;->k:Landroid/support/v4/f/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v4, Landroid/support/v7/widget/m;->d:[I
    ...
    invoke-static {p2}, Landroid/support/v7/widget/aj;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_3
    sget-object v4, Landroid/support/v7/widget/m;->g:[I
    ...
    :cond_4
    sget v4, Landroid/support/v7/b/a$e;->abc_list_divider_mtrl_alpha:I
    ...
    :cond_5
    sget v4, Landroid/support/v7/b/a$e;->abc_dialog_material_background:I
...
.method private b(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v7/widget/m;->c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method private b(Landroid/content/Context;)V
    ...
    sget v0, Landroid/support/v7/b/a$e;->abc_vector_test:I
...
.method private c(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    sget v0, Landroid/support/v7/b/a$a;->colorControlHighlight:I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/bi;->c(Landroid/content/Context;I)I
    ...
    sget-object v0, Landroid/support/v7/widget/bi;->d:[I
    ...
    :goto_1
    invoke-static {v3, v0}, Landroid/support/v4/c/a;->a(II)I
    ...
    sget-object v0, Landroid/support/v7/widget/bi;->b:[I
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/m;->k:Landroid/support/v4/f/a;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/m;->k:Landroid/support/v4/f/a;
...
.method a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    sget v2, Landroid/support/v7/b/a$e;->abc_edit_text_material:I

    if-ne p2, v2, :cond_4

    sget v0, Landroid/support/v7/b/a$c;->abc_tint_edittext:I

    invoke-static {p1, v0}, Landroid/support/v7/d/a/b;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/widget/m;->b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    sget v0, Landroid/support/v7/b/a$c;->abc_tint_switch_track:I
    ...
    sget v0, Landroid/support/v7/b/a$c;->abc_tint_switch_thumb:I
    ...
    invoke-direct {p0, p1, p3}, Landroid/support/v7/widget/m;->a(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p3}, Landroid/support/v7/widget/m;->b(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    :cond_8
    sget v2, Landroid/support/v7/b/a$e;->abc_btn_colored_material:I

    if-ne p2, v2, :cond_9

    invoke-direct {p0, p1, p3}, Landroid/support/v7/widget/m;->c(Landroid/content/Context;Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    :cond_9
    sget v2, Landroid/support/v7/b/a$e;->abc_spinner_mtrl_am_alpha:I

    if-eq p2, v2, :cond_a

    sget v2, Landroid/support/v7/b/a$e;->abc_spinner_textfield_background_material:I

    if-ne p2, v2, :cond_b

    :cond_a
    sget v0, Landroid/support/v7/b/a$c;->abc_tint_spinner:I
    ...
    :cond_b
    sget-object v2, Landroid/support/v7/widget/m;->e:[I

    invoke-static {v2, p2}, Landroid/support/v7/widget/m;->a([II)Z
    ...
    :cond_c
    sget-object v2, Landroid/support/v7/widget/m;->h:[I
    ...
    sget v0, Landroid/support/v7/b/a$c;->abc_tint_default:I
    ...
    :cond_d
    sget-object v2, Landroid/support/v7/widget/m;->i:[I
    ...
    sget v0, Landroid/support/v7/b/a$c;->abc_tint_btn_checkable:I
    ...
    :cond_e
    sget v2, Landroid/support/v7/b/a$e;->abc_seekbar_thumb_material:I

    if-ne p2, v2, :cond_0

    sget v0, Landroid/support/v7/b/a$c;->abc_tint_seek_thumb:I
...
.method a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/m;->b(Landroid/content/Context;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/aj;->b(Landroid/graphics/drawable/Drawable;)V

    :cond_3
    return-object v0
.end method

.method a(Landroid/content/Context;Landroid/support/v7/widget/bp;I)Landroid/graphics/drawable/Drawable;
    .locals 2
...
.method public a(Landroid/content/Context;)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/m;->m:Ljava/lang/Object;
...
.method b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v7/widget/m;->a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
