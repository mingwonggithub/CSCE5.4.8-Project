...
.field private u:Landroid/support/v7/widget/bc;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleTextAppearance:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_subtitleTextAppearance:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_android_gravity:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_buttonGravity:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleMargin:I

    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/bn;->d(II)I

    move-result v0

    sget v2, Landroid/support/v7/b/a$k;->Toolbar_titleMargins:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleMarginStart:I
    ...
    :cond_1
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleMarginEnd:I
    ...
    :cond_2
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleMarginTop:I
    ...
    :cond_3
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleMarginBottom:I
    ...
    :cond_4
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_maxButtonHeight:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_contentInsetStart:I
    ...
    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bc;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/bc;->b(II)V
    ...
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bc;

    invoke-virtual {v3, v0, v2}, Landroid/support/v7/widget/bc;->a(II)V

    :cond_6
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_contentInsetStartWithNavigation:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_contentInsetEndWithActions:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_collapseIcon:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_collapseContentDescription:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_title:I
    ...
    :cond_7
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_subtitle:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_popupTheme:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_navigationIcon:I
    ...
    :cond_9
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_navigationContentDescription:I
    ...
    :cond_a
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_logo:I
    ...
    :cond_b
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_logoDescription:I
    ...
    :cond_c
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_titleTextColor:I
    ...
    :cond_d
    sget v0, Landroid/support/v7/b/a$k;->Toolbar_subtitleTextColor:I
...
.method private s()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bc;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bc;
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ae;->q(Landroid/view/View;)I
...
.method protected onMeasure(II)V
    ...
    invoke-static {v1}, Landroid/support/v4/view/ae;->j(Landroid/view/View;)I

    move-result v1

    invoke-static {v9, v1}, Landroid/support/v7/widget/bs;->a(II)I
    ...
    invoke-static {v0}, Landroid/support/v4/view/ae;->j(Landroid/view/View;)I

    move-result v0

    invoke-static {v9, v0}, Landroid/support/v7/widget/bs;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/bs;->a(II)I
    ...
    invoke-static {v11, v4}, Landroid/support/v7/widget/bs;->a(II)I
    ...
    invoke-static {v2}, Landroid/support/v4/view/ae;->j(Landroid/view/View;)I

    move-result v2

    invoke-static {v11, v2}, Landroid/support/v7/widget/bs;->a(II)I
    ...
    invoke-static {v1, p1, v2}, Landroid/support/v4/view/ae;->a(III)I
    ...
    invoke-static {v0, p2, v2}, Landroid/support/v4/view/ae;->a(III)I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    :cond_2
    iget-boolean v0, p1, Landroid/support/v7/widget/Toolbar$SavedState;->c:Z
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/bc;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bc;->a(Z)V
