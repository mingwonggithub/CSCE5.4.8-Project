...
.method private a(Landroid/support/v7/widget/RecyclerView$v;IIJ)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView$a;->bindViewHolder(Landroid/support/v7/widget/RecyclerView$v;I)V
    ...
    iput p3, p1, Landroid/support/v7/widget/RecyclerView$v;->mPreLayoutPosition:I
...
.method private d(Landroid/view/View;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->mAccessibilityDelegate:Landroid/support/v7/widget/ay;

    invoke-virtual {v0}, Landroid/support/v7/widget/ay;->c()Landroid/support/v4/view/a;
...
.method a(IZJ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iput v3, v0, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$v;
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/widget/RecyclerView$o;->e(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    invoke-virtual {v0, v4, v1}, Landroid/support/v7/widget/RecyclerView$a;->createViewHolder(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iput-object v5, v0, Landroid/support/v7/widget/RecyclerView$v;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v1, v10}, Landroid/support/v7/widget/RecyclerView$v;->hasAnyOfTheFlags(I)Z

    move-result v0

    if-eqz v0, :cond_10

    invoke-virtual {v1, v7, v10}, Landroid/support/v7/widget/RecyclerView$v;->setFlags(II)V
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$s;

    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$v;->getUnmodifiedPayloads()Ljava/util/List;
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v7/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroid/support/v7/widget/RecyclerView$v;Landroid/support/v7/widget/RecyclerView$e$c;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$v;->isBound()Z

    move-result v0

    if-eqz v0, :cond_11

    iput p1, v1, Landroid/support/v7/widget/RecyclerView$v;->mPreLayoutPosition:I
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$v;->needsUpdate()Z

    move-result v0

    if-nez v0, :cond_12

    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$v;->isInvalid()Z
...
.method b(IZ)Landroid/support/v7/widget/RecyclerView$v;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->mChildHelper:Landroid/support/v7/widget/af;
...
.method b(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/RecyclerView$v;->access$700(Landroid/support/v7/widget/RecyclerView$v;)Z
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->mPrefetchRegistry:Landroid/support/v7/widget/an$a;

    iget v5, p1, Landroid/support/v7/widget/RecyclerView$v;->mPosition:I

    invoke-virtual {v3, v5}, Landroid/support/v7/widget/an$a;->a(I)Z
    ...
    iget-object v5, v5, Landroid/support/v7/widget/RecyclerView;->mPrefetchRegistry:Landroid/support/v7/widget/an$a;

    invoke-virtual {v5, v0}, Landroid/support/v7/widget/an$a;->a(I)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/br;->g(Landroid/support/v7/widget/RecyclerView$v;)V
...
.method b(Landroid/view/View;)V
    ...
    invoke-static {v0, v1}, Landroid/support/v7/widget/RecyclerView$v;->access$802(Landroid/support/v7/widget/RecyclerView$v;Landroid/support/v7/widget/RecyclerView$o;)Landroid/support/v7/widget/RecyclerView$o;

    const/4 v1, 0x0

    # setter for: Landroid/support/v7/widget/RecyclerView$v;->mInChangeScrap:Z
    invoke-static {v0, v1}, Landroid/support/v7/widget/RecyclerView$v;->access$902(Landroid/support/v7/widget/RecyclerView$v;Z)Z
...
.method c(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    # setter for: Landroid/support/v7/widget/RecyclerView$v;->mScrapContainer:Landroid/support/v7/widget/RecyclerView$o;
    invoke-static {p1, v0}, Landroid/support/v7/widget/RecyclerView$v;->access$802(Landroid/support/v7/widget/RecyclerView$v;Landroid/support/v7/widget/RecyclerView$o;)Landroid/support/v7/widget/RecyclerView$o;

    const/4 v0, 0x0

    # setter for: Landroid/support/v7/widget/RecyclerView$v;->mInChangeScrap:Z
    invoke-static {p1, v0}, Landroid/support/v7/widget/RecyclerView$v;->access$902(Landroid/support/v7/widget/RecyclerView$v;Z)Z
...
.method d()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->mPrefetchRegistry:Landroid/support/v7/widget/an$a;
...
.method d(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->mRecyclerListener:Landroid/support/v7/widget/RecyclerView$p;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/br;->g(Landroid/support/v7/widget/RecyclerView$v;)V
