...
# instance fields
.field b:Landroid/support/v7/widget/x$b;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/v7/widget/x;->a:Z
    ...
    :goto_1
    sput-boolean v0, Landroid/support/v7/widget/x;->e:Z
    ...
    sput-object v0, Landroid/support/v7/widget/x;->f:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/graphics/Rect;

    sget-object v0, Landroid/support/v7/b/a$k;->Spinner:[I

    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/bn;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bn;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/h;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->h:Landroid/content/Context;

    :goto_0
    iget-object v0, p0, Landroid/support/v7/widget/x;->h:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/x;->f:[I
    ...
    iget-object v2, p0, Landroid/support/v7/widget/x;->h:Landroid/content/Context;
    ...
    sget-object v5, Landroid/support/v7/b/a$k;->Spinner:[I

    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/bn;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bn;

    move-result-object v2

    sget v5, Landroid/support/v7/b/a$k;->Spinner_android_dropDownWidth:I

    const/4 v6, -0x2

    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/bn;->f(II)I

    move-result v5

    iput v5, p0, Landroid/support/v7/widget/x;->c:I

    sget v5, Landroid/support/v7/b/a$k;->Spinner_android_popupBackground:I

    invoke-virtual {v2, v5}, Landroid/support/v7/widget/bn;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/x$b;->a(Landroid/graphics/drawable/Drawable;)V

    sget v5, Landroid/support/v7/b/a$k;->Spinner_android_prompt:I

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bn;->d(I)Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/x$b;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->i:Landroid/support/v7/widget/am;

    :cond_2
    sget v0, Landroid/support/v7/b/a$k;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/bn;->f(I)[Ljava/lang/CharSequence;
    ...
    sget v0, Landroid/support/v7/b/a$h;->support_simple_spinner_dropdown_item:I
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/bn;->a()V

    iput-boolean v3, p0, Landroid/support/v7/widget/x;->k:Z

    iget-object v0, p0, Landroid/support/v7/widget/x;->j:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/x;->j:Landroid/widget/SpinnerAdapter;

    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/h;
    ...
    :cond_5
    sget v0, Landroid/support/v7/b/a$k;->Spinner_popupTheme:I

    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/bn;->g(II)I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->h:Landroid/content/Context;

    goto/16 :goto_0

    :cond_6
    sget-boolean v0, Landroid/support/v7/widget/x;->a:Z
...
.method a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->d:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/x;->d:Landroid/graphics/Rect;
...
.method public getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/x$b;
    ...
    :cond_0
    sget-boolean v0, Landroid/support/v7/widget/x;->e:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->i:Landroid/support/v7/widget/am;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/x;->i:Landroid/support/v7/widget/am;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/am;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/x;->j:Landroid/widget/SpinnerAdapter;
    ...
    :goto_1
    iget-object v1, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/x$b;
...
.method public setDropDownWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/x;->c:I
