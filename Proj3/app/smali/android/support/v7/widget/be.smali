...
.field b:Landroid/support/v7/widget/ap;

.field c:I

.field d:I

.field private e:Landroid/support/v7/widget/be$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/be;->j:Landroid/view/animation/Interpolator;
...
.method private a()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/be;->f:Landroid/widget/Spinner;
...
.method private b()V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/be;->d()Landroid/widget/Spinner;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/be;->f:Landroid/widget/Spinner;

    :cond_1
    iget-object v0, p0, Landroid/support/v7/widget/be;->b:Landroid/support/v7/widget/ap;
...
# virtual methods
.method a(Landroid/support/v7/a/a$c;Z)Landroid/support/v7/widget/be$c;
    .locals 4
    ...
    invoke-direct {v0, p0, v1, p1, p2}, Landroid/support/v7/widget/be$c;-><init>(Landroid/support/v7/widget/be;Landroid/content/Context;Landroid/support/v7/a/a$c;Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/be;->e:Landroid/support/v7/widget/be$b;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/be;->e:Landroid/support/v7/widget/be$b;
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p2}, Landroid/support/v7/widget/be$c;->b()Landroid/support/v7/a/a$c;
...
.method public onMeasure(II)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/be;->b:Landroid/support/v7/widget/ap;
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/be;->g:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/be;->b:Landroid/support/v7/widget/ap;

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/ap;->measure(II)V
...
.method public setAllowCollapse(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/be;->g:Z
