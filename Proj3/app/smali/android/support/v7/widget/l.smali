...
.method constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/l;->b:Landroid/content/res/ColorStateList;

    iput-object v1, p0, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v0, p0, Landroid/support/v7/widget/l;->d:Z

    iput-boolean v0, p0, Landroid/support/v7/widget/l;->e:Z

    iput-object p1, p0, Landroid/support/v7/widget/l;->a:Landroid/widget/CompoundButton;
...
.method a(I)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/l;->a:Landroid/widget/CompoundButton;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/l;->b:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/l;->b:Landroid/content/res/ColorStateList;

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/widget/l;->d:Z

    invoke-virtual {p0}, Landroid/support/v7/widget/l;->d()V
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->a:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/l;->a:Landroid/widget/CompoundButton;

    invoke-virtual {v3}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-static {v3, v0}, Landroid/support/v7/d/a/b;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
...
.method c()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/l;->f:Z
...
.method d()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/l;->d:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/widget/l;->e:Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/l;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/l;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/l;->a:Landroid/widget/CompoundButton;
