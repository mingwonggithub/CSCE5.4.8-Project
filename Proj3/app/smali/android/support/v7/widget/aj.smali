...
.method public static a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    sget-object v0, Landroid/support/v7/widget/aj;->b:Ljava/lang/Class;

    if-eqz v0, :cond_1

    :try_start_0
    invoke-static {p0}, Landroid/support/v4/c/a/a;->g(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object v1, Landroid/support/v7/widget/aj;->b:Ljava/lang/Class;
...
.method static b(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/aj;->d(Landroid/graphics/drawable/Drawable;)V
...
.method public static c(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v4}, Landroid/support/v7/widget/aj;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {v0}, Landroid/support/v7/widget/aj;->c(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    instance-of v0, p0, Landroid/support/v7/e/a/a;

    if-eqz v0, :cond_6

    check-cast p0, Landroid/support/v7/e/a/a;

    invoke-virtual {p0}, Landroid/support/v7/e/a/a;->a()Landroid/graphics/drawable/Drawable;
