...
.method private f()I
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ar;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/ak;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ak;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ak;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/ak;

    iget-object v6, p0, Landroid/support/v7/widget/ar;->z:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ak;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ak;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/ak;

    iget-object v6, p0, Landroid/support/v7/widget/ar;->C:Landroid/support/v7/widget/ar$c;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/ak;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
