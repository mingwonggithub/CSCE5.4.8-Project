...
.field private final j:Landroid/support/v7/widget/ap;
...
.method a(I)V
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/ar;->d()Z
    ...
    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ar;->g(I)V

    invoke-virtual {v3}, Landroid/support/v7/widget/ar;->a()V
    ...
    :cond_2
    invoke-virtual {v3}, Landroid/support/v7/widget/ar;->e()Landroid/widget/ListView;
    ...
    sget v2, Landroid/support/v7/b/a$i;->abc_activitychooserview_choose_application:I
...
.method getListPopupWindow()Landroid/support/v7/widget/ar;
    .locals 2
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ar;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ar;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->j:Landroid/support/v7/widget/ap;

    sub-int v1, p4, p2

    sub-int v2, p5, p3

    invoke-virtual {v0, v3, v3, v1, v2}, Landroid/support/v7/widget/ap;->layout(IIII)V
