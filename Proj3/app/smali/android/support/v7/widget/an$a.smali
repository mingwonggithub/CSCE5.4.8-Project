...
.method a(Landroid/support/v7/widget/RecyclerView;Z)V
    ...
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->mLayout:Landroid/support/v7/widget/RecyclerView$h;

    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->mAdapter:Landroid/support/v7/widget/RecyclerView$a;
    ...
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->mAdapterHelper:Landroid/support/v7/widget/f;
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v7/widget/RecyclerView$h;->collectInitialPrefetchPositions(ILandroid/support/v7/widget/RecyclerView$h$a;)V

    :cond_1
    :goto_0
    iget v1, p0, Landroid/support/v7/widget/an$a;->d:I

    iget v2, v0, Landroid/support/v7/widget/RecyclerView$h;->mPrefetchMaxCountObserved:I

    if-le v1, v2, :cond_2

    iget v1, p0, Landroid/support/v7/widget/an$a;->d:I

    iput v1, v0, Landroid/support/v7/widget/RecyclerView$h;->mPrefetchMaxCountObserved:I

    iput-boolean p2, v0, Landroid/support/v7/widget/RecyclerView$h;->mPrefetchMaxObservedInInitialPrefetch:Z

    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->mRecycler:Landroid/support/v7/widget/RecyclerView$o;
    ...
    iget-object v3, p1, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/RecyclerView$s;

    invoke-virtual {v0, v1, v2, v3, p0}, Landroid/support/v7/widget/RecyclerView$h;->collectAdjacentPrefetchPositions(IILandroid/support/v7/widget/RecyclerView$s;Landroid/support/v7/widget/RecyclerView$h$a;)V
