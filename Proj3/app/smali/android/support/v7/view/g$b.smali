...
.method private a(Landroid/view/MenuItem;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/p;->a(Landroid/view/MenuItem;I)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/p;->a(Landroid/view/MenuItem;Landroid/view/View;)Landroid/view/MenuItem;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/p;->b(Landroid/view/MenuItem;I)Landroid/view/MenuItem;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/view/p;->a(Landroid/view/MenuItem;Landroid/support/v4/view/d;)Landroid/view/MenuItem;
...
.method public a(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Landroid/support/v7/b/a$k;->MenuGroup:[I

    invoke-virtual {v0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/v7/b/a$k;->MenuGroup_android_id:I
    ...
    sget v1, Landroid/support/v7/b/a$k;->MenuGroup_android_menuCategory:I
    ...
    sget v1, Landroid/support/v7/b/a$k;->MenuGroup_android_orderInCategory:I
    ...
    sget v1, Landroid/support/v7/b/a$k;->MenuGroup_android_checkableBehavior:I
    ...
    sget v1, Landroid/support/v7/b/a$k;->MenuGroup_android_visible:I
    ...
    sget v1, Landroid/support/v7/b/a$k;->MenuGroup_android_enabled:I
...
.method public b(Landroid/util/AttributeSet;)V
    ...
    sget-object v3, Landroid/support/v7/b/a$k;->MenuItem:[I

    invoke-virtual {v0, p1, v3}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object v3

    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_id:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_menuCategory:I
    ...
    sget v4, Landroid/support/v7/b/a$k;->MenuItem_android_orderInCategory:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_title:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_titleCondensed:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_icon:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_alphabeticShortcut:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_numericShortcut:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_checkable:I
    ...
    :goto_1
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_checked:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_visible:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_enabled:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_showAsAction:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_android_onClick:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_actionLayout:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_actionViewClass:I
    ...
    sget v0, Landroid/support/v7/b/a$k;->MenuItem_actionProviderClass:I
