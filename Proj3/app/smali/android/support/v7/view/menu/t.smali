...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/h;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/au;
...
.method private h()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/au;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/au;->a(Z)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/au;->g(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/au;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/au;->e()Landroid/widget/ListView;
    ...
    sget v1, Landroid/support/v7/b/a$h;->abc_popup_menu_header_item_layout:I
...
.method public a(Landroid/support/v7/view/menu/u;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/au;

    invoke-virtual {v1}, Landroid/support/v7/widget/au;->j()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/view/menu/t;->a:Landroid/support/v7/widget/au;

    invoke-virtual {v2}, Landroid/support/v7/widget/au;->k()I
