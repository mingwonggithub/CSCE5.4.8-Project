...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/a/c;
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/a/c$a;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/support/v7/view/menu/f;

    invoke-virtual {v1}, Landroid/support/v7/a/c$a;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/a/c$a;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/a/c$a;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/c$a;->a(Landroid/view/View;)Landroid/support/v7/a/c$a;

    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/a/c$a;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/a/c$a;

    invoke-virtual {v1}, Landroid/support/v7/a/c$a;->b()Landroid/support/v7/a/c;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/a/c;

    iget-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/a/c;

    invoke-virtual {v0, p0}, Landroid/support/v7/a/c;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/a/c;

    invoke-virtual {v0}, Landroid/support/v7/a/c;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/a/c$a;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/a/c$a;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/a/c$a;->a(Ljava/lang/CharSequence;)Landroid/support/v7/a/c$a;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/i;->c:Landroid/support/v7/a/c;

    invoke-virtual {v1}, Landroid/support/v7/a/c;->getWindow()Landroid/view/Window;
